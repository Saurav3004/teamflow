...
import HeroLight from '@/public/light-ss.png'
import HeroDark from '@/public/dark-ss.png'
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                   ...
                                   Tailflow organizes conversation into channels with threads,is real time and uses AI to keep teams in sync.
                                </TextEffect>
